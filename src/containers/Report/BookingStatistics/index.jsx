...
class BookingStatistics extends Component {
  render() {
    const { bookingStatistics } = this.props.Report;
              ...
              onSubmit={(values, { setSubmitting }) => {
                setTimeout(() => {
                  ...
                  if (param.result === "view") {
                    reportView(param, "Thống kê booking hàng ngày", 1);
                  } else {
                    reportDownload(param, "Thống kê booking hàng ngày", 1);
                    setSubmitting(false);
                  }
                  setSubmitting(false);
                }, 400);
...
export default connect(mapStateToProps, mapDispatchToProps)(BookingStatistics);
