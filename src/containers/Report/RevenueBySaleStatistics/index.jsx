...
class RevenueBySaleStatistics extends Component {
  render() {
    ...
    const { revenueBySaleStatistics } = this.props.Report;
    const {
      pages,
      pageSize,
      totalLength,
              ...
              onSubmit={(values, { setSubmitting }) => {
                setTimeout(() => {
                  ...
                  if (param.result === "view") {
                    reportView(param, "Báo cáo doanh thu theo sale", 4);
                  } else {
                    reportDownload(param, "Báo cáo doanh thu theo sale", 4);
                    setSubmitting(false);
                  }
                  setSubmitting(false);
                }, 400);
              ...
              <RevenueBySaleStatisticsList
                onChangeCurrentPage={currentPage => {
                  reportView(
                    ...
                    "Báo cáo doanh thu theo nhân viên sale",
                    4
                  );
                }}
