...
export class CategoryPartnerList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
  ...
  handleEditCategoryPartner(rowData) {
    this.props.handleEditCategoryPartner(rowData);
  }

  handleDeleteCategoryPartner(rowData) {
  ...
  showDeleteConfirm(rowData) {
    ...
    confirm({
      ...
      cancelText: "Không",
      onOk() {
        _this.props.handleDeleteCategoryPartner(rowData);
      },
      onCancel() {
        console.log("Cancel");
      },
...
export default CategoryPartnerList;
