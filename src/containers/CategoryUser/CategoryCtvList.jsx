...
export class CategoryCtvList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
      ...
      tableColumnExtensions: [
        ...
        { columnName: "col_3", width: 150, wordWrapEnabled: true },
  ...
  handleViewCategoryCtv(rowData) {
    this.props.handleViewCategoryCtv(rowData);
  }

  handleEditCategoryCtv(rowData) {
    this.props.handleEditCategoryCtv(rowData);
  }

  handleDeleteCategoryCtv(rowData) {
  ...
  showDeleteConfirm(rowData) {
    ...
    confirm({
      ...
      cancelText: "Không",
      onOk() {
        _this.props.handleDeleteCategoryCtv(rowData);
      },
      onCancel() {
        console.log("Cancel");
      },
...
export default CategoryCtvList;
