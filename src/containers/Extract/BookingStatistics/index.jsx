      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="kt-portlet">
              ...
              onSubmit={(values, { setSubmitting }) => {
                setTimeout(() => {
                  ...
                  if (query.resultType === "view") {
                    reportView(query, "Thống kê booking hàng ngày", 1);
                  } else {
                    reportDownload(query, "Thống kê booking hàng ngày", 1);
                    setSubmitting(false);
                  }
                  setSubmitting(false);
                }, 400);
            ...
            <BookingStatisticsList dataSource={listBooking} loading={false} />
            </div> */}
          </div>
        </div>
      </div>
