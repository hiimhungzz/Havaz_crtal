...
class VehicleUpload extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleConfirm() {
        ...
        // reqwest({
        //     url: `${API_IMPORT_BASE_URL}/import_vehicle`,
        //     method: 'post',
        //     processData: false,
        //     data: formData,
        //     success: (response) => {
        ...
        //                 message: 'Upload danh sách phương tiện',
        //                 description: <List
        //                     size="small"
        //                     style={{width: '100%'}}
        //                     dataSource={data}
...
export const VehicleUploadWrapped = withStyles(styles)(VehicleUpload);