      ...
      data: [
        {
          ...
          route: "Hà Nội - Khu Công nghiệp Bắc Ninh",
          duration: "3 năm - 20/11/2020",
          typeVehicle: "35C - 10 xe",
          status: "Chuyến cố định",
        },
        {
          id: "2",
          contractNumber: "HĐ/SS-2020-01",
      ...
      <Spin spinning={readCorporateFetching} tip="Đang lấy dữ liệu...">
        <Grid container spacing={1}>
          ...
          <Grid className="pt-5" item xs={12}>
            ...
            <ContractList grid={contracts} setContracts={setContracts} />
          </Grid>
        </Grid>
      </Spin>
