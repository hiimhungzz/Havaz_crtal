...
import CustomerDebtByMonthStatisticsFilter from './CustomerDebtByMonthStatisticsFilter';
import CustomerDebtByMonthStatisticsList from'./CustomerDebtByMonthStatisticsList';

const CustomerDebtByMonthStatistics = () => {
  ...
  return (
    <div className="kt-portlet kt-portlet--mobile">
      <CustomerDebtByMonthStatisticsFilter
...
export default CustomerDebtByMonthStatistics;
