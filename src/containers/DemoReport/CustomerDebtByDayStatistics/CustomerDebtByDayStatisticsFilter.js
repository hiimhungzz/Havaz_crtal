...
const CustomerDebtByDayStatisticsFilter = memo(
              ...
              <div className="input-group">
                  <SelectBaseSon
                    ...
                    onSelect={(item) => {
                      setParams(prevState=>{
                        let nextState= {...prevState};
                          nextState.driverName = item;
                          return nextState;
                        })
                    }}
                    apiUrl={API_URI.GET_LIST_DRIVER_REPORT}
                    pageLimit={20}
                    placeholder="Lái xe"
                  />
              </div>
...
export default CustomerDebtByDayStatisticsFilter;
