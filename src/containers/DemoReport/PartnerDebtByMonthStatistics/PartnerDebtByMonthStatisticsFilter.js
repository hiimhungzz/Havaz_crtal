...
const PartnerDebtByMonthStatisticsFilter = memo(
        ...
        <div className="kt-portlet__body">
          ...
          <div className="form-group row">
            ...
            <div className="col-md-3">
              ...
              <div className="input-group">
                <SelectBaseSon
                  value={values.organCode}
                  onSelect={(item) => {
                    setParams(prevState=>{
                      let nextState= {...prevState};
                        nextState.organCode = item;
                        return nextState;
                      })
                  }}
                  apiUrl={API_URI.GET_CODE_CTV}
                  pageLimit={20}
                  placeholder="Mã CTV"
                />
              </div>
...
export default PartnerDebtByMonthStatisticsFilter;
