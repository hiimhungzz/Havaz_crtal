...
const DebtByCTVStatisticsFilter = memo(
              ...
              <div className="input-group">
                <RangePicker
                  ...
                  onChange={dates => {
                    setParams(prevState=>{
                      let nextState= {...prevState};
                        nextState.startDate = moment(dates[0].startOf("day")).format('YYYY-MM-DD');
                        nextState.endDate = moment(dates[1].endOf("day")).format('YYYY-MM-DD');
                        return nextState;
                      })
                    }}
                  ranges={{
...
export default DebtByCTVStatisticsFilter;
