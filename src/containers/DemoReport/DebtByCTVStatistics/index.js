...
// components
import DebtByCTVStatisticsFilter from './DebtByCTVStatisticsFilter';
import DebtByCTVStatisticsList from './DebtByCTVStatisticsList';

const DebtByCTVStatistics = () => {
...
export default DebtByCTVStatistics;
