...
export class DriverCtv extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
      ...
      tableColumnExtensions: [
        ...
        { columnName: "col_2", width: 150, wordWrapEnabled: true },
  ...
  handleEditDriverParner(rowData) {
    this.props.handleEditDriverParner(rowData);
  }

  handleDeleteParnerDriver(rowData) {
  ...
  showDeleteConfirm(rowData) {
    ...
    confirm({
      ...
      cancelText: "Không",
      onOk() {
        _this.props.driverParnerDelete(rowData);
      },
      onCancel() {
        console.log("Cancel");
      },
