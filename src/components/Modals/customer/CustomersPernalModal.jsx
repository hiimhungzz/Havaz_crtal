...
class CustomersPernalModal extends React.Component {
  ...
  render() {
    const { actionName, dataSource, onClose, spinning, onCreate } = this.props;
    const {
      getFieldDecorator,
      setFieldsValue,
      getFieldValue
          ...
          <div id="cr-drawer__body" className="kt-portlet__body">
            <Spin spinning={spinning}>
              <Row gutter={10}>
                ...
                <Col span={24}>
                  <Form.Item label="Tên khách hàng" colon={false}>
...
CustomersPernalModal.defaultProps = {
  dataSource: {
    files: []
  }
};
export default Form.create({
  name: "CustomersPernalModal",
  mapPropsToFields: props => {
    return props.data;
  }
})(CustomersPernalModal);
