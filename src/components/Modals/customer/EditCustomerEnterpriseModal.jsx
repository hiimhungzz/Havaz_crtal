...
class EditCustomerEnterpriseModal extends React.Component {
...
EditCustomerEnterpriseModal.defaultProps = {
  dataSource: {
    files: []
  }
};
export default Form.create({
  name: "EditCustomerEnterpriseModal",
  mapPropsToFields: props => {
    return props.data;
  }
})(EditCustomerEnterpriseModal);
