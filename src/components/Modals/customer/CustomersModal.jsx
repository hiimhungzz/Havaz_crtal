...
class OwnerSelect extends React.PureComponent {
  ...
  fetchUser = searchInput => {
    ...
    requestJson({ url: url || API_URI.GET_LIST_USER, data: param }).then(
      response => {
        const data = response.data.data.map((user, userId) => {
          return {
            key: user.uuid,
            label: user.fullName,
              ...
              {actionName === "edit" ? (
                        ...
                        <Form.Item colon={false} label="Nv sale phụ trách">
                          {getFieldDecorator("ownerId", {
                            ...
                            <OwnerSelect
                              url={
                                tabId === 1
                                  ? "users/select/bP/list"
                                  : "users/select/bC/list"
                              }
                      ...
                      <Col span={12}>
                        <Form.Item label="SĐT NV sale phụ trách">
                          {getFieldDecorator("ownerPhone", {
                            ...
                            <Input
                              disabled
                              placeholder={"SĐT NV sale phụ trách"}
                            />
                          )}
                        </Form.Item>
                      </Col>
                ...
                <Row gutter={10}>
                    ...
                    <Form.Item colon={false} label="Nhóm khách hàng">
                      {getFieldDecorator("category", {
                        ...
                        <SelectCategory
                          organizationId={
                            getFieldValue("parentId")
                              ? getFieldValue("parentId").key || parentId.key
                              : parentId.key
                          }
                          url="category-user-all"
                          placeholder="Nhóm khách hàng"
                  ...
                  <Col span={24}>
                    <Form.Item
                      label={
                        tabId === 1 ? "Tên KH doanh nghiệp" : "Tên khách hàng"
                      }
                      colon={false}
                    >
                      {getFieldDecorator("name", {
