...
class CategoryModalPartner extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataSource: {}
          ...
          <div className="kt-portlet">
            <div id="cr-drawer__head" className="kt-portlet__head">
              <div className="kt-portlet__head-label">
                <h3 className="kt-portlet__head-title">
                  ...
                  &nbsp;
                  {actionName === "edit"
                    ? `Chỉnh sửa Nhóm lái xe CTV (ID : ${dataSource.id})`
                    : actionName === "create"
            ...
            <div id="cr-drawer__body" className="kt-portlet__body">
              ...
              <Col span={24}>
                ...
                <Col span={24}>
                  <Form.Item label="Nhóm lái xe CTV" className="ant-center">
                    ...
                    })(<Input placeholder="Nhóm lái xe CTV" />)}
                  </Form.Item>
                </Col>
