...
import { Drawer, Form, Col, Row, Input, DatePicker, Rate, Radio } from "antd";
        ...
        onSubmit={e => {
          ...
          this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
              ...
              submitData["driversLicenseCode"] = values.driversLicenseCode
      ...
      >
        <div className="kt-portlet">
            ...
            <div className="kt-portlet__head-label">
              <h3 className="kt-portlet__head-title">
                <a onClick={this.props.onClose}>
                  ...
                  {actionName === "edit"
                    ? `Chỉnh sửa thông tin lái xe (Mã : ${dataSource.code})`
                    : actionName === "create"
                    ? "Thêm thông tin lái xe"
                    : `Chỉnh sửa thông tin lái xe (Mã : ${dataSource.code})`}
                </a>
              </h3>
            </div>
          ...
          <div id="cr-drawer__body" className="kt-portlet__body">
            <Row gutter={10}>
              <Col span={12}>
                <Form.Item className="ant-center1" label="Doanh Nghiệp">
                  {getFieldDecorator("organizationId", {
                    initialValue:
                      dataSource.organUuid && dataSource.organName
                        ? {
              ...
              <Col span={12} className="ant-center1">
              ...
              {/* <Col span={6}>
                  <Form.Item label="Nhóm lái xe" className="ant-center1">
                    {getFieldDecorator("groupDriver", {
                      initialValue: dataSource.groupDriver
                        ? { key: dataSource.groupDriver.key }
                        : undefined,
                      rules: [
                        {
                          required: true,
                      ...
                      <SelectBase
                        onSelect={(item) => {
                          setFieldsValue({groupDriver: item})
                        }}
                        apiUrl={API_URI.GET_GROUP_XE}
                        pageLimit={20}
                        placeholder="Nhóm lái xe"
                      />
                    )}
                  </Form.Item>
                </Col> */}
...
const App = Form.create({})(DriverCreate);
